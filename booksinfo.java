...
public class booksinfo extends JFrame {
	...
	public booksinfo() {
		...
		comboBoxSelection.setModel(new DefaultComboBoxModel(new String[] {"SN", "Title", "Author", "Year", "BNO"}));
		comboBoxSelection.setBounds(290, 41, 161, 30);
		contentPane.add(comboBoxSelection);
		
		JLabel lblNewLabel = new JLabel("* BNO, YEAR, SN must be in number");
		lblNewLabel.setForeground(Color.RED);
		lblNewLabel.setBounds(10, 300, 202, 14);
